...
public class RegistrationService {
    ...
    // public Mono<Void> patchClientNode(ClientNode node, RSocketRequester
    // requester) {
    ...
    // log.info(String.format("Client with uuid '%s' successfully established
    // rsocket connection.", uuid));
